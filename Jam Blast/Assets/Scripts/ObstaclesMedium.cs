...
public class ObstaclesMedium : MonoBehaviour
{
    ...
    public int poolSize = 15;                                   //How many columns to keep on standby.
    public float spawnRate = 3f;                                    //How quickly columns spawn.
    public float yMin = -1f;                                    //Minimum y value of the column position.
    public float yMax = 1.7f;                                    //Maximum y value of the column position.
    ...
    void Start()
    {
        ...
        for(int i = 0; i < poolSize; i++)
        {
            ...
            obstacles[i] = (GameObject)Instantiate(prefabs[Random.Range(0, 6)], objectPoolPosition, Quaternion.identity);
        }
    }
